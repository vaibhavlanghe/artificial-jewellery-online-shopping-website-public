...
$query = "SELECT p.pname,p.pdescription,p.pprice,p.ptype,i.PID,i.PATH FROM products p JOIN images i WHERE p.pnumber = i.PID AND p.ptype = 'rings'";
...
//	echo $arr[0]['pname'];
	...
	for($i = count($arr)-1;$i >= 0; $i--){
		...
		$dynamicList='<div class="thumbnail"><a href="order.php" id="link1">
